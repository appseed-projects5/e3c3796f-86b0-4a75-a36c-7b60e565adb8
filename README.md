...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-12-23 23:50`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e3c3796f-86b0-4a75-a36c-7b60e565adb8.git
$ cd e3c3796f-86b0-4a75-a36c-7b60e565adb8
```
